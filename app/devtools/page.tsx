      ...
      tasks: [
        {
          ...
          solution: {
            steps: [
              ...
              "  a) ВАЖНО: Сначала кликните мышкой в панель DevTools (справа)",
              "  b) Затем нажмите Ctrl+F в панели Elements",
              "  c) Введите 'devtools-demo' в поле поиска",
              "  d) Нажимайте стрелку вниз ⬇️ пока не найдете HTML элемент (не текст инструкции)",
              "  e) Элемент должен быть выделен желтым цветом",
        ...
        },
        {
          ...
          solution: {
            steps: [
              ...
              "  a) Прокрутите страницу вниз до синего блока 'Демо элемент для практики'",
              "  b) Введите: document.querySelector('.devtools-demo')",
              "  c) Нажмите Enter",
              "  d) В консоли должен появиться HTML элемент <div class='devtools-demo'>",
