    ...
    const functionalLesson: FunctionalLesson = {
      ...
      tasks: [
        ...
        },
        {
          ...
          description: "Быстрая проверка основной функциональности приложения",
          category: "Smoke",
          completed: false,
          challenge: "Выполните smoke тестирование: быстро проверьте основные функции приложения - навигацию, авторизацию, основные страницы и критические пути пользователя.",
          beforeImage: "/screenshots/functional/smoke-before.svg",
          afterImage: "/screenshots/functional/smoke-after.svg",
          solution: {
            steps: [
              "1. Проверьте загрузку главной страницы:",
              "  • Откройте главную страницу приложения",
              "  • Убедитесь, что страница загружается без ошибок",
              "  • Проверьте отображение основных элементов",
              "2. Проверьте навигацию:",
              "  • Кликните по основным ссылкам в меню",
              "  • Убедитесь, что переходы работают",
              "  • Проверьте кнопку 'Назад' в браузере",
              "3. Проверьте авторизацию:",
              "  • Перейдите на страницу входа",
              "  • Войдите с тестовыми данными",
              "  • Убедитесь в успешном входе",
              "4. Проверьте основные функции:",
              "  • Откройте страницу с задачами",
              "  • Проверьте отображение контента",
              "  • Убедитесь в работоспособности форм",
              "5. Проверьте выход:",
              "  • Выйдите из системы",
              "  • Убедитесь в перенаправлении на главную",
              "  • Проверьте, что защищенные страницы недоступны"
            ],
            tips: [
              "Smoke тестирование должно быть быстрым - не более 15-20 минут",
              "Фокусируйтесь на критических путях пользователя",
              "Проверяйте только основные функции, не детали",
              "Цель - убедиться, что приложение 'дышит' и основные функции работают"
            ]
          }
        }
      ]
                  ...
                  <div className="flex-1">
                    <div className="flex items-center gap-3 mb-2">
                      ...
                      <span className={`px-3 py-1 rounded-full text-sm font-medium ${
                        ...
                        task.category === 'Smoke' ? 'bg-yellow-100 text-yellow-800' :
