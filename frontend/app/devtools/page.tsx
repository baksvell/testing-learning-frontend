  ...
  useEffect(() => {
    ...
    const devToolsLesson: DevToolsLesson = {
      ...
      tasks: [
        ...
        {
          id: 4,
          title: "Отладка JavaScript - простой способ",
          description: "Научитесь использовать отладчик для поиска ошибок в веб-приложениях и понимания как работает код",
          category: "Sources",
          completed: false,
          challenge: "Попробуйте отладчик на простом примере: поставьте breakpoint и посмотрите как работает код пошагово.",
          solution: {
            steps: [
              "1. Откройте DevTools (F12) и перейдите на вкладку Sources",
              "2. Найдите простой код для отладки:",
              "  • В левой панели Sources найдите папку 'Snippets' (Сниппеты)",
              "  • Если папки нет, создайте новый сниппет: нажмите '+' рядом с 'Snippets'",
              "  • Назовите его 'debug-demo'",
              "3. Скопируйте код в сниппет:",
              "  • Вставьте код из демо-блока ниже в редактор сниппета",
              "  • Нажмите Ctrl+S для сохранения",
              "4. Поставьте breakpoint:",
              "  • Найдите строку с 'console.log('Начинаем расчет...')'",
              "  • Кликните на номер строки слева - появится красная точка",
              "  • Это breakpoint - код остановится на этой строке",
              "5. Запустите отладку:",
              "  • Нажмите Ctrl+Enter в сниппете или кнопку 'Run' (▶️)",
              "  • Код остановится на breakpoint",
              "  • В правой панели 'Scope' видны переменные a, b, result",
              "6. Изучите отладчик:",
              "  • ▶️ Continue - продолжить выполнение",
              "  • ⏭️ Step Over (F10) - выполнить одну строку",
              "  • ⏬ Step Into (F11) - войти в функцию",
              "  • В панели 'Scope' смотрите значения переменных"
            ],
            tips: [
              "💡 Сниппеты - это простой способ тестировать код без сложной навигации",
              "🔍 Breakpoint останавливает выполнение кода для анализа",
              "📊 В панели 'Scope' видны все переменные и их значения",
              "⏭️ Step Over (F10) - самый часто используемый способ пошаговой отладки",
              "❌ Удалить breakpoint: кликните на красную точку еще раз",
              "🎯 Отладчик помогает понять, почему код работает неправильно",
              "📝 Используйте отладку для описания багов в отчетах",
              "🚀 Сниппеты можно сохранить и использовать повторно",
              "🐛 Практический пример: если кнопка не работает, поставьте breakpoint в обработчике события",
              "🔍 Реальный случай: если форма не отправляется, отладьте функцию валидации",
              "📋 В баг-репорте укажите: 'Код останавливается на строке X, переменная Y = undefined'"
            ]
          }
        },
        {
                ...
                <div className="flex items-start justify-between mb-6">
                  ...
                  {task.category === 'Sources' && (
                    <div className="my-3 p-4 bg-orange-50 border border-orange-200 rounded-lg">
                      <div className="font-semibold text-orange-800 mb-2">🎯 Простой способ изучить отладчик</div>
                      <p className="text-orange-700 mb-3">Используйте сниппеты DevTools - это самый простой способ попробовать отладчик!</p>
                      
                      <div className="bg-purple-50 border border-purple-200 p-3 rounded mb-3">
                        <p className="text-purple-800 text-sm">
                          <strong>🤔 Зачем нужна отладка?</strong><br/>
                          • <strong>Найти ошибки:</strong> Понять почему код работает неправильно<br/>
                          • <strong>Изучить логику:</strong> Посмотреть как выполняется код пошагово<br/>
                          • <strong>Проверить переменные:</strong> Увидеть какие значения принимают переменные<br/>
                          • <strong>Описать баги:</strong> Точно объяснить разработчику где проблема<br/>
                          • <strong>Тестировать сценарии:</strong> Проверить как код ведет себя в разных условиях
                        </p>
                      </div>
                      
                      <div className="bg-green-50 border border-green-200 p-3 rounded mb-3">
                        <p className="text-green-800 text-sm">
                          <strong>✅ Простая инструкция:</strong><br/>
                          1. Откройте Sources в DevTools<br/>
                          2. Найдите папку "Snippets" (Сниппеты) в левой панели<br/>
                          3. Создайте новый сниппет: нажмите "+" рядом с "Snippets"<br/>
                          4. Скопируйте код ниже в сниппет<br/>
                          5. Поставьте breakpoint и запустите отладку!
                        </p>
                      </div>
                      
                      {/* Простой код для копирования */}
                      <div className="bg-gray-900 text-white p-4 rounded-lg mb-3 font-mono text-sm">
                        ...
                        <div className="ml-4 text-yellow-300">console.log('Начинаем расчет...'); // ← Поставьте breakpoint здесь</div>
                        <div className="ml-4 text-white">const result = a + b;</div>
                        <div className="ml-4 text-yellow-300">console.log('Результат:', result); // ← И здесь</div>
                      ...
                      <div className="bg-blue-50 border border-blue-200 p-3 rounded mb-3">
                        <p className="text-blue-800 text-sm">
                          <strong>💡 Как использовать сниппеты:</strong><br/>
                          • Сниппеты - это как блокнот для JavaScript кода<br/>
                          • Не нужно искать код в сложных папках<br/>
                          • Просто копируете, вставляете и тестируете<br/>
                          • Идеально для изучения отладчика!
                        </p>
                      </div>
