    ...
    const devToolsLesson: DevToolsLesson = {
      ...
      tasks: [
        ...
        },
        {
          ...
          category: "Console",
          completed: false,
          challenge: "Используйте консоль DevTools для выполнения JavaScript команд: выведите сообщение в консоль, найдите демо-элемент внизу страницы (с классом 'devtools-demo') и измените заголовок страницы. Консоль - это мощный инструмент для отладки и тестирования JavaScript кода.",
          ...
          solution: {
            steps: [
              ...
              "6. Измените заголовок страницы:",
              "  • В консоли введите: document.title = 'DevTools Урок - Изучаем!';",
              "  • Нажмите Enter",
              "  • Проверьте заголовок вкладки браузера - он должен измениться",
            ...
            tips: [
              ...
              "🎨 document.title изменяет заголовок вкладки браузера",
