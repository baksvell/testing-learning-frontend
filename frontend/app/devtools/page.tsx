    ...
    const devToolsLesson: DevToolsLesson = {
      ...
      tasks: [
        ...
        },
        {
          ...
          category: "Console",
          completed: false,
          challenge: "Используйте консоль DevTools для выполнения JavaScript команд: выведите сообщение в консоль, найдите демо-элемент внизу страницы (с классом 'devtools-demo') и измените заголовок этого элемента. Консоль - это мощный инструмент для отладки и тестирования JavaScript кода.",
          ...
          solution: {
            steps: [
              ...
              "5. Найдите демо-элемент на странице:",
              "  • Сначала визуально: прокрутите страницу вниз до синего блока 'Демо элемент для практики'",
              "  • Затем программно: в консоли введите: document.querySelector('.devtools-demo')",
              "  • Нажмите Enter",
              "  • В консоли должен появиться HTML элемент: <div class='devtools-demo'>...</div>",
              "6. Измените заголовок демо-элемента:",
              "  • В консоли введите: document.querySelector('.devtools-demo').innerHTML = '<h2>Новый заголовок элемента!</h2><p>Этот элемент создан специально для практических заданий по DevTools. Попробуйте изменить его стили, атрибуты или содержимое!</p><button>Нажми меня!</button>';",
              "  • Нажмите Enter",
              "  • Проверьте заголовок элемента 'Демо элемент для практики' - он должен измениться на 'Новый заголовок элемента!'",
              "  • Альтернативный способ (если нужно изменить только текст): document.querySelector('.devtools-demo').textContent = 'Новый заголовок элемента!';",
            ...
            tips: [
              ...
              "🔧 innerHTML заменяет все содержимое элемента на новую HTML-строку",
              "📝 textContent изменяет только текстовое содержимое (без HTML тегов)",
              "🎯 innerHTML лучше для полной замены, textContent - для простого текста",
              "⚠️ Внимание: проверьте правильность написания querySelector (с заглавной Q)",
              "💡 Если innerHTML не работает, попробуйте textContent для простого текста"
            ]
          }
        },
        {
