        ...
        },
        {
          ...
          solution: {
            steps: [
              ...
              "  • В консоли введите: document.querySelector('.devtools-demo').querySelector('h2, h1, .title, span').textContent = 'Новый заголовок элемента!';",
              "  • Нажмите Enter",
              "  • Проверьте заголовок элемента 'Демо элемент для практики' - он должен измениться на 'Новый заголовок элемента!'",
              "  • Если команда не работает, попробуйте: document.querySelector('.devtools-demo').innerHTML = '<h2>Новый заголовок элемента!</h2><p>Этот элемент создан специально для практических заданий по DevTools. Попробуйте изменить его стили, атрибуты или содержимое!</p><button>Нажми меня!</button>';",
            ...
            tips: [
              ...
              "🔍 querySelector('h2, h1, .title, span') ищет заголовок внутри элемента",
              "📝 Если команда не работает, попробуйте: document.querySelector('.devtools-demo').innerHTML",
              "🔧 Простая альтернатива: document.querySelector('.devtools-demo').innerHTML = '<h2>Новый заголовок!</h2>';",
