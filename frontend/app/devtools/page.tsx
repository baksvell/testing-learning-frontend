  ...
  useEffect(() => {
    ...
    const devToolsLesson: DevToolsLesson = {
      ...
      tasks: [
        ...
        {
          id: 4,
          title: "Отладка JavaScript для тестировщиков",
          description: "Научитесь анализировать код веб-приложений, находить причины ошибок и исследовать поведение приложения при тестировании",
          category: "Sources",
          completed: false,
          challenge: "Используйте отладчик для исследования кода: поставьте breakpoint и пошагово выполните функцию, изучив как работает логика приложения и где могут возникать ошибки.",
          solution: {
            steps: [
              "1. Откройте DevTools (F12) и перейдите на вкладку Sources",
              "2. Найдите код для исследования:",
              ...
              "3. Поставьте breakpoint для анализа:",
              ...
              "  • Это breakpoint - код остановится на этой строке для анализа",
              "4. Запустите исследование кода:",
              "  • Нажмите кнопку 'Запустить отладку' ниже",
              "  • Код остановится на breakpoint - теперь можно анализировать",
              "  • В правой панели 'Scope' видны переменные a, b, result",
              "5. Исследуйте выполнение кода:",
              "  • ▶️ Continue - продолжить выполнение до следующего breakpoint",
              "  • ⏭️ Step Over (F10) - выполнить текущую строку и остановиться на следующей",
              "  • ⏬ Step Into (F11) - войти в функцию для детального анализа",
              "6. Анализируйте состояние приложения:",
              "  • В панели 'Scope' → 'Local' видны значения переменных в данный момент",
              "  • В панели 'Watch' можно добавить выражения для отслеживания изменений",
              "  • В панели 'Call Stack' видна цепочка вызовов функций"
            ],
            tips: [
              "🔍 Breakpoints помогают найти причины ошибок в веб-приложениях",
              "📊 В панели 'Call Stack' видна цепочка вызовов - полезно для анализа сложных сценариев",
              "👀 В панели 'Watch' можно отслеживать изменения переменных во время тестирования",
              "❌ Удалить breakpoint: кликните на красную точку еще раз",
              "⚙️ Условные breakpoints можно создать правым кликом - остановка только при определенных условиях",
              "🐛 Sources панель - основной инструмент для исследования багов в JavaScript",
              "📝 Используйте отладку для детального описания ошибок в баг-репортах",
              "🎯 Анализируйте код при воспроизведении сложных сценариев тестирования"
            ]
          }
        },
        {
                ...
                <div className="flex items-start justify-between mb-6">
                  ...
                  {task.category === 'Sources' && (
                    <div className="my-3 p-4 bg-orange-50 border border-orange-200 rounded-lg">
                      <div className="font-semibold text-orange-800 mb-2">Демо: исследование кода для тестировщиков</div>
                      <p className="text-orange-700 mb-3">Используйте код ниже для практики анализа JavaScript. Поставьте breakpoint и исследуйте как работает логика приложения.</p>
                      <div className="bg-yellow-50 border border-yellow-200 p-3 rounded mb-3">
                        <p className="text-yellow-800 text-sm">
                          <strong>🔍 Как исследовать код в Sources:</strong><br/>
                          ...
                          4. Поставьте breakpoint на строке с console.log для анализа<br/>
                          5. Нажмите кнопку "Запустить отладку" ниже
                        </p>
                      </div>
                      
                      {/* Интерактивный код для исследования */}
                      <div className="bg-gray-900 text-white p-4 rounded-lg mb-3 font-mono text-sm">
                        <div className="text-gray-400 mb-2">// Код для исследования логики приложения:</div>
                        <div>function calculateSum(a, b) {'{'}</div>
                        <div className="ml-4 text-yellow-300">console.log('Начинаем расчет...'); // ← Поставьте breakpoint для анализа</div>
                        <div className="ml-4">const result = a + b;</div>
                        <div className="ml-4 text-yellow-300">console.log('Результат:', result); // ← И здесь для проверки результата</div>
                        <div className="ml-4">return result;</div>
                        <div>{'}'}</div>
                        <div className="mt-2">calculateSum(5, 3); // ← Вызов функции для тестирования</div>
                      </div>
