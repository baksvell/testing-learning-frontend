    ...
    const devToolsLesson: DevToolsLesson = {
      ...
      tasks: [
        ...
        },
        {
          ...
          category: "Sources",
          completed: false,
          challenge: "Используйте отладчик JavaScript: поставьте breakpoint в коде ниже и пошагово выполните функцию, изучив переменные в процессе.",
          solution: {
            steps: [
              ...
              "  • Или найдите функцию 'calculateSum' в коде ниже",
              ...
              "6. Изучите переменные:",
              "  • В панели 'Scope' → 'Local' видны значения переменных",
              "  • В панели 'Watch' можно добавить выражения для отслеживания"
            ],
            tips: [
              ...
              "💡 Sources панель - основной инструмент для отладки JavaScript"
            ]
          }
        },
        {
                ...
                <div className="flex items-start justify-between mb-6">
                  ...
                  {task.category === 'Sources' && (
                    <div className="my-3 p-4 bg-orange-50 border border-orange-200 rounded-lg">
                      <div className="font-semibold text-orange-800 mb-2">Демо: отладка JavaScript</div>
                      <p className="text-orange-700 mb-3">Используйте код ниже для практики отладки. Поставьте breakpoint и изучите переменные.</p>
                      
                      {/* Интерактивный код для отладки */}
                      <div className="bg-gray-900 text-white p-4 rounded-lg mb-3 font-mono text-sm">
                        <div className="text-gray-400 mb-2">// Код для отладки:</div>
                        ...
                        <div>{'}'}</div>
                        <div className="mt-2">calculateSum(5, 3);</div>
                      </div>
