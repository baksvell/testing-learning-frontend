  ...
  const currentLesson: PostmanLesson = {
    ...
    tasks: [
      ...
      },
      {
        ...
        challenge: "Откройте демо Postman (кнопка выше) и изучите интерфейс, максимально похожий на настоящий Postman. Запустите коллекцию тестов и проанализируйте результаты.",
        beforeImage: "/screenshots/postman/testing-before.svg",
        afterImage: "/screenshots/postman/testing-after.svg",
        solution: {
          steps: [
            "1. Откройте демо Postman (кнопка выше)",
            "2. Изучите интерфейс:",
            "  • Левая панель: коллекции, окружения, история",
            "  • Центральная область: отправка запросов",
            "  • Нижняя панель: консоль и инструменты",
            "3. Запустите коллекцию тестов:",
            "  • Нажмите 'Запустить коллекцию'",
            "  • Наблюдайте за выполнением в реальном времени",
            "  • Изучите результаты выполнения",
            "4. Проанализируйте результаты:",
            "  • GET и POST запросы: статус 200/201 (успех)",
            "  • PUT, PATCH, DELETE: статус 404 (ошибка)",
            "  • Время ответа и размер данных",
            "5. Поймите принципы тестирования API:",
