      ...
      },
      {
        ...
        solution: {
          steps: [
            ...
            "  • В демо: нажмите 'Запустить коллекцию'",
            "  • В настоящем Postman: используйте Collection Runner",
            ...
            tips: [
              ...
              "💻 Настоящий Postman: скачайте с postman.com/downloads",
              ...
              "🔄 Collection Runner в настоящем Postman для запуска коллекций"
            ]
        }
      }
    ]
